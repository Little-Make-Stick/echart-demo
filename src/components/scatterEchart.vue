<template>
    <div class="scatter-echart-component-contain" ref="baseScatterChart" style="width: 100%">
        <!-- 散点图的二次封装 -->
...
export default {
    props: {
        titleText: { type: String, default: 'Base Scatter EChart Example' },
        color: { type: Array },
    ...
    data() {
        return {
            ...
            option: {
                title: {
                    text: 'Base Scatter EChart Example',
                },
                tooltip: {},
                color: [],
                legend: {
